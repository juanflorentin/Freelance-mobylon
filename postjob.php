...
<title>Freelancer Pro - Post a new job listing</title>
<meta name="description" content="A powerful jobs promotions website. Post a Job or Find a Job." />
<meta name="keywords" content="job, jobs, job listings, listings, category, work, seek, find, employment, staff, jobs board, business, marketing, promotions" />
...
<div id="main">
	<div class="container">
		<div class="row">
			<div class="span9">
<div class="page-header"><center><h1>Post a new job listing</h1></center></div>
<div class="span8">
<form action="savejob.php" class="form-horizontal well" method="post" enctype="multipart/form-data" name="frm" id="frm" onsubmit="return validate(this);">
...
<div class="control-group">
	...
	<div class="controls">
<input name="jobtitle" id="jobtitle" class="mytextbox" type="text" size="50" value="<?=$_GET['jobtitle'];?>" />
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
<input name="location" id="location" class="mytextbox" type="text" size="50" value="<?=$_GET['address2'];?>" />
	</div>
</div>


<div class="control-group">
	<label class="control-label" for='bidtype' >Job type * : </label> 
	<div class="controls">
...
<div class="control-group">
	...
	<div class="controls">
<textarea name="ddesc" cols="40" rows="5" id="ddesc"></textarea>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
	<input name="cname" id="cname" class="mytextbox" type="text" size="50" value="<?=$_GET['cname'];?>" />                        	</div>
</div>                       
...
<div class="control-group">
	...
	<div class="controls">
	<input name="website" id="website" class="mytextbox" type="text" size="50" value="<?=$_GET['address2'];?>" />
	</div>
	</div>
...
<div class="control-group">
	...
	<div class="controls">
	<input name="email" id="email" class="mytextbox" type="text" size="50" value="<?=$_GET['address2'];?>" />
	</div>
	</div>
...
<div class="control-group">
	...
	<div class="controls">
	<input name="password" id="password" class="mytextbox" type="password" size="50" value="<?=$_GET['password'];?>" />
	</div>
	</div>
...
&nbsp;&nbsp;
<input name="btn" class="btn" type="button" value="Cancel" onclick="document.location='alljobs.php';"/>
</center>
                            </form>
                  </div>
			</div>
