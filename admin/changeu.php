				 ...
				 if ($num > 0)
					{
						...
						echo '<script type="text/javascript">document.location="logout.php?un=changed";</script>';
					}
					else
					{
						echo '<script type="text/javascript">document.location="changeu.php?act=notdone";</script>';
         ...
         <TD  bgcolor="#FFFFFF" align="left" valign="top" style="border-right:10px solid #ebebeb; width:140px;">
          ...
          <TD   align="left" valign="top"  bordercolor="#FF6600" style="padding-left:15px;"><p><span class="titulos" ><span class="botones"><font size="3" style="verdana" color="#015fe7"><BR><B>Security </B></font></span></span></p>
            ...
            <div align="left" style="vertical-align:top">
              <table width="98%" border="0" style="border:1px solid #000000" cellspacing="0" cellpadding="0" bordercolor="#000000">
                <tr>
                  <td bgcolor="#1A3E6E" class="boxtop"><div align="center" class="linkcls">CHANGE
                    USER NAME</div></td>
                </tr>
                <tr>
                  <td height="258"><form action="changeu.php" method="post" enctype="multipart/form-data" name="frmurl" id="frmurl" onSubmit="return validate(this)">
                      <table width="521" height="246" border="0" align="center" cellspacing="5">
                        <tr align="center" valign="top">
                          <td height="21" colspan="3"><font  size="2"  color="#CC0033" face="Arial, Helvetica, sans-serif">
						   ...
						   { ?>
                            &nbsp;</font>
                              <table width="400" border="0" bgcolor="#F4F3E8"
		   style="BORDER-TOP: #767238 1px solid;
  				  BORDER-BOTTOM: #767238 1px solid;
		          BORDER-LEFT: #767238 1px solid;
                  BORDER-RIGHT: #767238 1px solid;">
                                <tr>
                                  <td height="17" align="center" valign="top" bgcolor="#006633"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Username 
                                    has been changed successfully, Please Re-Login</strong></font></td>
                                </tr>
                              </table>
                            <?php }
						   ?>
		   ...
		   style="BORDER-TOP: #767238 1px solid;
                  ...
                  BORDER-RIGHT: #767238 1px solid;">
                                <tr>
                                  <td width="443" height="17" align="center" valign="top" bgcolor="#990000"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Your
                                    Passwrod is not correct, Please Try
                                    with valid Password.</strong></font></td>
                                </tr>
                              </table>
                            <?php }
						   ?>                          </td>
                        ...
                        <tr valign="top">
                          ...
                          <td width="133" valign="middle"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> Old
                            UserName:&nbsp;</font></td>
                        ...
                        <tr valign="top">
                          ...
                          <td valign="middle"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> Password:&nbsp;</font></td>
                          <td height="1"><p align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                              <input name="passcode" type="password" class="First" id="passcode"  style="font-family: Verdana; font-size: 10pt; color: #000066; border: 1px solid #CAC3BF; background-image:     url('field_bg.jpg')" size="20" />
                          </font></p></td>
                        </tr>
                        <tr valign="top">
                          ...
                          <td height="24"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                              <input name="u1" type="text" class="First" id="u1" style="font-family: Verdana; font-size: 10pt; color: #000066; border: 1px solid #CAC3BF; background-image:     url('field_bg.jpg')" value="" size="20" />
                          </font></div></td>
                        </tr>
                        <tr valign="top">
                        ...
                        <tr valign="top">
                          <td colspan="3" height="26"><div align="center">
                              ...
                              <input type="submit" name="Submit" value="Change User" class="boxtop" />
